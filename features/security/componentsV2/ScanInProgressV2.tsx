...
export const ScanInProgressV2: React.FC<ScanInProgressProps> = ({ moduleStatus, currentTask, scanProgress, etr }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full p-6 bg-gray-50 dark:bg-gray-900">
             ...
             <div className="relative z-10 w-full max-w-lg text-center">
                <h2 className="text-2xl font-bold mb-2">V2 Engine Running...</h2>
                <p className="text-gray-600 dark:text-gray-400 mb-4">The multitasking engine is analyzing the codebase in parallel. Please wait.</p>
